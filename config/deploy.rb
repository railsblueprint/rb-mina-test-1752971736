...
set :application, "mina_test_736"
set :application_name, "mina_test_736"  # Required for mina-puma-nginx gem
set :repository, 'git@github.com:railsblueprint/rb-mina-test-1752971736.git'
